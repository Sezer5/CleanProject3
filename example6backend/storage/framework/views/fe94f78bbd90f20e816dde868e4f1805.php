                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card p-3">
                            ...
                            <div class="card-body col-md-6">
                                <form action="<?php echo e(route('admin.product.update', $product->slug)); ?>" method="post"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select form-select-sm" name="category_id">
                                            <option value="<?php echo e($product->category_id); ?>" selected>
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            value="<?php echo e($product->quantity, old('quantity')); ?>" />
                                        ...
                                        <select multiple class="form-select form-select-sm" name="color_id[]">
                                            <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($color->id); ?>"
                                                    <?php if($product->colors->contains($color->id)): ?> selected <?php endif; ?>><?php echo e($color->name); ?>
                                        ...
                                        <select multiple class="form-select form-select-sm" name="size_id[]">
                                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($size->id); ?>"
                                                    <?php if($product->sizes->contains($size->id)): ?> selected <?php endif; ?>>
...
<?php echo $__env->make('layouts.adminlayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\example6\example6backend\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>
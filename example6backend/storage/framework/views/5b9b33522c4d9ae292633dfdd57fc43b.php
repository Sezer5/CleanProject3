                ...
                <div class="ms-auto d-flex align-items-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                            ...
                            <li><a class="dropdown-item text-danger" href="<?php echo e(route('admin.logout')); ?>"><i class="bi bi-box-arrow-right me-2"></i>Çıkış Yap</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        </nav>
<?php /**PATH C:\xampp\htdocs\example6\example6backend\resources\views/layouts/header.blade.php ENDPATH**/ ?>
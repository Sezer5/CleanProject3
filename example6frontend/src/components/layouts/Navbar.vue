<template>
  <nav
    class="navbar sticky-top navbar-expand-lg navbar-light bg-light mb-2 shadow-sm border border-3"
  >
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form
          @submit.prevent="productStore.fetchProductsByTerm(data.term)"
          class="d-flex"
        >
          <input
